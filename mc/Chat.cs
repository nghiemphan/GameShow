...
namespace mc
{
    public partial class chatmc : Form
    {
        public string data;
        public chatmc()
        {
        ...
        private frmMC mainFrom = null;
        public chatmc(Form callingForm)
        {
            mainFrom = callingForm as frmMC;
            InitializeComponent();
            CheckForIllegalCrossThreadCalls = false;
            Connect();
        }

        private void chatmc_FormClosed(object sender, FormClosedEventArgs e)
        {
            _Close();
        }
        IPEndPoint IP;
